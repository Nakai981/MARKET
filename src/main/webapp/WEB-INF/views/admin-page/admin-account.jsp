                    ...
                    <table>
                        ...
                        <c:forEach var="i" items="${listEmployee}">
                            <tr>
                                ...
                                <td> <c:out value = "${i.getCard()}"/><p></td>
                                <td> <c:out value = "${i.getPhone()}"/><p></td>
                                <td><c:out value = "${i.getAddress()}"/><p></td>
                                <td> <c:out value = "${i.getUser()}"/><p></td>
                                <td> <c:out value = "${i.getPass()}"/><p></td>
                                ...
                                <td><a style="color: #bd4147"href="/admin/account/delete?id=${i.getId()}"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
